...
description: A beginner-friendly guide to web harmonium keyboard notes, white and black key layout, and how Sargam labels relate to western note names online.
...
When beginners open a Web Harmonium page, the first challenge is usually not sound. It is orientation.

Which keys are the main notes? Where do the black keys fit? How do Sargam names relate to western notes?

This guide helps answer those questions in a way that works for Web Harmonium practice and faster note recognition.
